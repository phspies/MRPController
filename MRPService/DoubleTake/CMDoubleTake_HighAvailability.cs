...
namespace MRPService.DoubleTake
{
    public class MRPDoubleTake_HighAvailability : MRPDoubleTake_Core
    {
        ...
        //public static void dt_create_ha_syncjob(MRPTaskType request)
        //{
        ...
        //            {
        //                CloudMRP.task().progress(request, String.Format("Deleting existing HA jobs between {0} and {1}", _source_ips[0], _target_ips[0]), 10);
