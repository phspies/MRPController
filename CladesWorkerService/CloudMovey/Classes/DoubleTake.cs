...
namespace CloudMoveyWorkerService.CloudMovey.Controllers
{
    class DT
    {
        ...
        static CloudMoveyWorkerService.CloudMovey.CloudMovey CloudMovey = null;
        ...
        {
            _payload = payload;
            CloudMovey = new CloudMoveyWorkerService.CloudMovey.CloudMovey(Global.apiBase, null, null);
