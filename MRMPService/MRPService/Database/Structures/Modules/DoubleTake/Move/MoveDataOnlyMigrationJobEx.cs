...
{
    //public class MoveDataOnlyMigrationJobEx : JobBase, IExample
    //{
    //    public MoveDataOnlyMigrationJobEx() : base("MoveDataOnlyMigration")
    //    { }
    ...
    //        {
    //            SimpleLog.Log("Creating Move Data-Only Migration job.");
