    ...
    partial class DRSServersDormant
    {
        static public void SetupDormantRecoveryJob(MRPTaskType _mrmp_task)
        {
            ...
            try
            {
                ...
                DisasterRecovery.CreateDRServerRecoveryJob(_mrmp_task.id, _source_workload, _target_workload, _original_workload, _protectiongroup, _managementobject, _snapshot, 66, 99);
