...
namespace MRMPService.Modules.DoubleTake.Common
{
    ...
    {
        public static void StartJob(MRPTaskType _task, MRPWorkloadType _target_workload, MRPManagementobjectType _managementobject, float _start_progress, float _end_progress)
        {
