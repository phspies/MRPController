...
namespace MRMPService.Modules.DoubleTake.DR
{
    ...
    {
        public static void CreateDRServerProtectionJob(MRPTaskType _task, MRPWorkloadType _source_workload, MRPWorkloadType _target_workload, MRPProtectiongroupType _protectiongroup, MRPManagementobjectType _managementobject, float _start_progress, float _end_progress)
        {
